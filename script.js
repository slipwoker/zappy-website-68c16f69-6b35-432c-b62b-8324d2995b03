document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const validateField = function (field) {
      ...
      for (let i = 0; i < rules.length; i++) {
        ...
        if (validators[rule] && !validators[rule](value, param)) {
          showError(field, getErrorMessage(field, rule, param));
          return false;
        }
      }
    ...
    contactForm.addEventListener('blur', function (e) {
      ...
      if (!field) return;
      if (field.getAttribute('data-validate') || field.type === 'email') {
        validateField(field);
      }
    }, true);
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .catch(function (error) {
          ...
          const errorMsg = contactForm.querySelector('.form-submit-error');
          if (errorMsg) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "AI Con משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '68c16f69-6b35-432c-b62b-8324d2995b03',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '68c16f69-6b35-432c-b62b-8324d2995b03';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '68c16f69-6b35-432c-b62b-8324d2995b03';
